...
local enUSValues = {
  ...
  ["tips.mode.master"] = "Combat Modes\n|cffffffffActivate or deactivate the selected Combat Mode.\nSelecting an option does not activate it.\n|cffff0000Left-click to activate or deactivate the selected mode|r\n|cff999999(Executed by: Raid, Party)|r\n\n|cffff0000Right-click to show or hide Options|r\n|cff999999(Executed by: System)|r",
  ["tips.mode.passive"] = "Passive Mode\n|cffffffffBots will not attack anything.\nUseful for keeping Tanks from aggroing adds during a pull.\nThe Stay and Follow commands cancel Passive Mode.|r\n\n|cffff0000Left-click to select|r\n|cff999999Use the main Combat Modes button to activate or deactivate it.|r",
  ["tips.mode.grind"] = "Grind Mode\n|cffffffffBots attack independently on their own.\nUseful for leveling up your Bots.|r\n\n|cffff0000Left-click to select|r\n|cff999999Use the main Combat Modes button to activate or deactivate it.|r",
  ["tips.mode.flee"] = "Flee Mode\n|cffffffffThe entire Party or Raid flees to you while ignoring everything else.|r\n\n|cffff0000Left-click to select|r\n|cff999999Use the main Combat Modes button to activate or deactivate it.|r",
  ["tips.mode.guard"] = "Guard Mode\n|cffffffffBots hold their current positions while out of combat, but move normally once combat begins.\nTurning Guard Mode off returns them to Follow.|r\n\n|cffff0000Left-click to select|r\n|cff999999Use the main Combat Modes button to activate or deactivate it.|r",
  ...
  ["options.tabs.player"] = "Player",
  ["options.player_rest_regen.title"] = "Player rest regeneration",
  ["options.player_rest_regen.description"] = "While enabled, sitting still below 65% mana restores 5% of maximum mana per second. It never restores health and stops when you move or enter combat.",
  ["options.player_rest_regen.enable"] = "Automatic free mana regeneration while resting",
  ["options.player_rest_regen.enable_desc"] = "Saved per character. Requires the MultiBot bridge and GM aura permission.",
  ["options.player_rest_regen.auto_sit"] = "Automatically sit after 5 seconds while low on mana",
  ["options.player_rest_regen.auto_sit_desc"] = "Only acts below 65% mana while safely stationary and out of combat. Saved per character.",
  ["options.player_rest_regen.updating"] = "Waiting for server acknowledgement...",
  ["options.player_rest_regen.error"] = "Server error",
  ["options.player_rest_regen.error.UNAUTHORIZED"] = "Your account does not have aura-command permission.",
  ["options.player_rest_regen.error.UPDATE_TIMEOUT"] = "The bridge did not acknowledge the change.",
  ["options.player_rest_regen.error.BRIDGE_UNAVAILABLE"] = "The bridge is unavailable.",
  ["options.player_rest_regen.saved_offline"] = "Preference saved. It will be sent when the bridge connects.",
  ["options.player_rest_regen.active"] = "Enabled on the server for this character.",
  ["options.player_rest_regen.inactive"] = "Disabled on the server for this character.",
  ...
  ["tips.inventory.sellvendor"] = "Sell vendorable items|cffffffff\nThe Bot sells all items that it classifies as vendorable. This action does not use the addon's maximum sell-rarity setting.\nProtected items (keys, Hearthstone, etc.) are never sold.|r\n\n|cffff0000Shift-click to sell\nOnly affects the Bot whose inventory is open.|r\n|cff999999(Executed by: Bot)|r",
  ["info.inventorysellvendorshift"] = "Hold Shift while clicking Sell Vendor.",
  ["info.inventorysellrarityalert"] = "Sale blocked by the maximum sell-rarity setting.",
  ["options.tabs.inventory"] = "Inventory",
  ["options.inventory.title"] = "Inventory safety",
  ["options.inventory.max_sell_quality"] = "Maximum sell rarity",
  ["options.inventory.max_sell_quality_desc"] = "Individual Sell actions above this rarity are blocked. Sell Vendor is not covered and requires Shift-click.",
  ...
  ["options.tabs.maintenance"] = "Maintenance",
  ["options.maintenance.title"] = "Alt-bot maintenance policy",
  ["options.maintenance.description"] = "The maintenance level is saved per character and restored when you reconnect. Server policy remains authoritative while connected.",
  ["options.maintenance.repair"] = "Repair enabled",
  ["options.maintenance.repair_desc"] = "Allow alt-bot maintenance to repair durability.",
  ["options.maintenance.min_level"] = "Minimum master level (1-80)",
  ["options.maintenance.min_level_desc"] = "Alt maintenance is skipped when the controlling player is below this level.",
  ["options.maintenance.refresh"] = "Refresh server policy",
  ["options.maintenance.querying"] = "Querying server policy...",
  ["options.maintenance.updating"] = "Waiting for server acknowledgement...",
  ["options.maintenance.error"] = "Server error",
  ["options.maintenance.bridge_unavailable"] = "Bridge unavailable. Controls are disabled.",
  ["options.maintenance.feature_unavailable"] = "Maintenance policy controls are unavailable on this server.",
  ["options.maintenance.current"] = "Scope: global alt bots. Repair %s; minimum master level %d.",
  ["options.maintenance.error.BRIDGE_UNAVAILABLE"] = "Bridge unavailable",
  ["options.maintenance.error.SEND_FAILED"] = "Request could not be sent",
  ["options.maintenance.error.FEATURE_UNAVAILABLE"] = "Feature unavailable or request timed out",
  ["options.maintenance.error.UPDATE_TIMEOUT"] = "Update timed out",
  ["options.maintenance.error.LEVEL_OUT_OF_RANGE"] = "Enter a whole number from 1 to 80",
  ["options.maintenance.error.MALFORMED_RESPONSE"] = "Malformed server response",
  ["options.maintenance.error.UNAUTHORIZED"] = "No controlled alt bot is available",
  ["options.maintenance.error.EXPECTED_ON_OR_OFF"] = "Repair must be ON or OFF",
  ["options.maintenance.error.EXPECTED_INTEGER"] = "Level must be a whole number",
  ["options.maintenance.error.OUT_OF_RANGE_1_80"] = "Level must be from 1 to 80",
  ["options.maintenance.error.UNKNOWN_FIELD"] = "Unknown policy field",
  ["options.maintenance.error.VALUE_TOO_LONG"] = "Policy value is too long",
  ["options.maintenance.error.INVALID_TOKEN"] = "Invalid request token",
}
